...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, q) {
        ...
        if ("function" == typeof p) {
            ...
            for (p = b.length, u = 0; u < p; u++) h.push(d.call(q, b[u], u));
        return h
    }
}, "es6", "es3");
...
(function() {
                ...
                if (b) {
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                        ...
                        var r = function() {
                            ...
                            f.style.width = null;
                            f.clientWidth >
                                b && (f.style.width = "100%", f.style.height = null)
                        };
                        ...
                        a.querySelector(".mbr-fallback-image") && (b = window.getComputedStyle(a.querySelector(".mbr-fallback-image")).backgroundImage,
                            b = b.match(/\((.*?)\)/)[1].replace(/('|")/g, ""), f.setAttribute("poster", b));
        ...
        if ("undefined" !==
            ...
            if (n) {
                ...
                g(document).on("changeParameter.cards", function(a, b, e, d) {
                    if ("bg" === b) switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", g(a.target).find(".mbr-background-video-preview").remove(),
                        g(a.target).find(".mbr-background-video").remove(), d) {
                        case "type":
    ...
    if (!n) {
        if (v && g.fn.socialLikes) g(document).on("add.cards",
            function(a) {
    ...
    if (!n && (0 < window.navigator.userAgent.indexOf("MSIE ") ||
                ...
                b = function(b) {
                    ...
                    f.addEventListener("click", function(b) {
                        "VIDEO" !== b.target.tagName && (d ? (-1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',
                            "*"), -1 !== d.indexOf("vimeo") && e.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(), f.style.display = "none", f.removeEventListener("click", a), h.style.zIndex = "0")
                    })
                };
        ...
        "undefined" === typeof window.initTestimonialsPlugin && 0 != document.body.querySelectorAll(".testimonials-slider").length && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function(a) {
            ...
            a.addEventListener("click", function() {
                ...
                !d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ?
                    (g.classList.remove("mbri-arrow-up"), g.classList.add("mbri-arrow-down")) : (g.classList.remove("mbri-arrow-down"), g.classList.add("mbri-arrow-up")), -1 != b.indexOf("accordion") && (b = a.closest(".accordionStyles"), Array.from(b.children).filter(function(a) {
