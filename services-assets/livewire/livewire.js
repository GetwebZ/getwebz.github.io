...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
    ...
    directive("model", (el, {
        ...
        let removeListener = isCloning ? () => {} : on2(el, event, modifiers, (e) => {
    ...
    function upload(component, name, file, finishCallback = () => {}, errorCallback = () => {}, progressCallback = () => {}) {
        let uploadManager = getUploadManager(component);
        uploadManager.upload(name, file, finishCallback, errorCallback, progressCallback);
    }

    function uploadMultiple(component, name, files, finishCallback = () => {}, errorCallback = () => {}, progressCallback = () => {}) {
        let uploadManager = getUploadManager(component);
    ...
    function src_default5(Alpine3) {
        Alpine3.directive("intersect", (el, {
            value,
            expression,
            modifiers
        }, {
